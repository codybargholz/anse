...
export const promptCategoryHelper = {
  summarizeText: (text: string) => {
    return [
      ...
      'Based on the context of the input categorize it as Science, Medicine, History, Philosophy, Writing, Computer, Business, Ideas, Economics, Yomiko, Charlie or Other.',
      ...
      'Science: Marvin',
      'Medicine: Terry Wahls',
      'History: Winston Churchill',
      'Computer: Dennis Ritchie',
      'Business: Elon Musk',
      'Writing: Shirley Taylor',
      'Philosophy: Hubert "Bert" Dreyfus',
      'Ideas: Steve Jobs',
      'Charlie: Charlie',
